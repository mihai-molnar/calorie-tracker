...
export function Dashboard() {
  ...
  if (error || !data) {
    return <div className="p-4 text-center text-red-600">{error || "Failed to load dashboard"}</div>;
  }
  ...
  return (
    <div className="max-w-md mx-auto px-4 py-6 space-y-6">
        ...
        <div className="flex justify-between">
          <div>
            <p className="text-2xl font-bold text-gray-900">
              ...
              <span className="text-sm text-gray-500 font-normal"> / {data.today.daily_calorie_target} kcal</span>
            </p>
            <p className="text-sm text-green-600">{data.today.calories_remaining} remaining</p>
          </div>
          {data.today.weight_kg && (
            <div className="text-right">
              <p className="text-2xl font-bold text-gray-900">{data.today.weight_kg}</p>
      ...
      <div className="bg-white rounded-xl p-4 shadow-sm border border-gray-100">
        <h2 className="text-sm font-medium text-gray-500 mb-1">7-Day Average</h2>
      ...
      <div className="bg-white rounded-xl p-4 shadow-sm border border-gray-100">
        <h2 className="text-sm font-medium text-gray-500 mb-3">Daily Calories</h2>
